/* LoansForElectricians match form — AdaptLend engine. One big friendly question per screen. */
...
const SITE = {
  "key": "loansforelectricians",
  "brand": "LoansForElectricians",
  "questions": [
    {
      "id": "goal",
      "question": "What brings you here today?",
      "hint": "Cash-out and equity lines are our specialty \u2014 OT, per-diem, and deposits all count.",
      "options": [
        {
          "value": "cashout",
          "icon": "banknote",
  ...
  "reviews": [
    {
      "quote": "Two lenders used my base rate. My specialist documented three years of storm work and doubles \u2014 the approval went up $190K.",
      "who": "Mike B.",
      "meta": "W-2 + OT purchase \u00b7 Cleveland, OH"
    },
    {
      "quote": "Left the local to start my own shop, and twelve months in I bought a house on my deposits. Nobody blinked at the write-offs.",
      "who": "Andre F.",
